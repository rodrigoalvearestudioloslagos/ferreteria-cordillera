      ...
      <div className="page-wrap">
        ...
        <div className="grid-contacto">
          {[
            ...
            <div key={t} style={{ background: "#102844", border: "1px solid #1A3F6F", borderRadius: 20, padding: "36px 28px", textAlign: "center", transition: "border-color 0.2s" }}
              ...
              <h3 style={{ color: "#F5B800", fontWeight: 800, fontSize: 13, letterSpacing: "0.08em", textTransform: "uppercase", margin: "0 0 10px" }}>{t}</h3>
